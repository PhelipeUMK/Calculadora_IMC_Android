...
public class desnutricao3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_desnutricao3);
        ...
        TextView txt = findViewById(R.id.txtImc_desnIII);
        ...
        Button voltar = findViewById(R.id.btnDesnIII);
