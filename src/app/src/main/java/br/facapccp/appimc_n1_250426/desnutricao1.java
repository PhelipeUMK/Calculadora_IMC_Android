...
public class desnutricao1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txt = findViewById(R.id.txtImc_desnI);
        txt.setText("Seu IMC:" + String.valueOf(imcFormatado));

        setContentView(R.layout.activity_desnutricao1);
        ...
        Button voltar = findViewById(R.id.btnDesnI);
