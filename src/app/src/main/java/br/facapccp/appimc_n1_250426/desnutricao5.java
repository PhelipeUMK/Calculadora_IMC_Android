...
public class desnutricao5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_desnutricao5);
        ...
        TextView txt = findViewById(R.id.txtImc_desnV);
        ...
        Button voltar = findViewById(R.id.btnDesnV);
