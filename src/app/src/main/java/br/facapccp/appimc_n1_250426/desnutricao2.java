...
public class desnutricao2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_desnutricao2);
        ...
        TextView txt = findViewById(R.id.txtImc_desnII);
        ...
        Button voltar = findViewById(R.id.btnDesnII);
