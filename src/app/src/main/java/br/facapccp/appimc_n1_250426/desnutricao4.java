...
public class desnutricao4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_desnutricao4);
        ...
        TextView txt = findViewById(R.id.txtImc_desnIV);
        ...
        Button voltar = findViewById(R.id.btnDesnIV);
